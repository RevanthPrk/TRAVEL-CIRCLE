            ...
            <div class="container">
                <div class="signup-content">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="process.php">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
                                ...
                                <input  name="phone" type="tel" minlength="10" maxlength="10" id="phone" placeholder="PHONE NUMBER"  required />
                    ...
                    <div class="signup-image">
                        ...
                        <a href="link.php" class="signup-image-link">I AM ALREADY A MEMBER</a>
