					...
					?>
                        <form method="POST" class="register-form" id="register-form" action="change_password_a.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="old_pass" id="old_pass" placeholder="PASSWORD"  required />
                            </div>
                            <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="password" name="new_pass" id="new_pass" placeholder="REPEAT YOUR PASSWORD"  required />
